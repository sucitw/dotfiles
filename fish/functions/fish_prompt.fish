# Customized fish theme modified from theme agnoster and Zish
# * https://github.com/oh-my-fish/theme-agnosteri
...
function prompt_virtual_env -d "Display Python virtual environment"
  if test "$VIRTUAL_ENV"
    prompt_segment black grey "("(basename $VIRTUAL_ENV)")"
	set_color normal
  end
end
